...
/**
 * Detecta la calidad de un streaming .m3u8 analizando el Master Playlist
 */
export async function detectQuality(url, headers = {}) {
    try {
        ...
        if (!data.includes("#EXT-X-STREAM-INF")) {
            // Si no es un master playlist, intentar extraer del nombre del archivo
