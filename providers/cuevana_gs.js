 ...
 * Generated: 2026-04-13T03:29:33.958Z
 */
      ...
      return __async(this, null, function* () {
        ...
        try {
          ...
          const [idsRes, infoRes] = yield Promise.all([
            axios5.get(idUrl, { timeout: 4e3, headers: { "User-Agent": UA5 } }),
            axios5.get(infoUrl, { timeout: 4e3, headers: { "User-Agent": UA5 } })
          ]);
          const res = {
    ...
    try {
      ...
      var performSearch = function(query) {
        return __async(this, null, function* () {
          ...
          try {
            var responseText = yield fetchHtml(searchUrl);
      ...
      var getOnlineStreams = function(url) {
        return __async(this, null, function* () {
          ...
          try {
            ...
            var response = yield fetchHtml(apiUrl);
...
var import_engine, import_resolvers, import_cheerio_without_node_native, import_id_mapper, BASE_URL, TMDB_API_KEY;
