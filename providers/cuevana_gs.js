 ...
 * Generated: 2026-04-15T20:54:39.952Z
 */
    ...
    try {
      ...
      var performSearch = function(query) {
        return __async(this, null, function* () {
          ...
          try {
            var responseText = yield (0, import_http2.fetchHtml)(searchUrl);
      ...
      var getOnlineStreams = function(url) {
        return __async(this, null, function* () {
          ...
          try {
            ...
            var response = yield (0, import_http2.fetchHtml)(apiUrl);
...
var import_http2, import_engine, import_resolvers, import_cheerio_without_node_native, import_id_mapper, BASE_URL, TMDB_API_KEY;
