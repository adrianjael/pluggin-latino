 ...
 * Generated: 2026-04-09T16:39:05.477Z
 */
...
function getStreams(tmdbId, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      console.log(`[PelisPlusHD] Title from TMDB: "${title}"`);
      const streams = yield extractStreams(title, tmdbId, mediaType, season, episode);
      if (streams.length === 0) {
