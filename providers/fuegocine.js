 ...
 * Generated: 2026-04-15T23:34:49.332Z
 */
...
var { fetchHtml: fetchHtml2, fetchJson: fetchJson2 } = require_http();
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const searchJson = yield fetchJson2(SEARCH_BASE + encodeURIComponent(searchTitle));
      ...
      for (const entry of entries) {
        ...
        if (!normEntry.includes(normTitle))
          continue;
        const html = yield fetchHtml2(entryUrl);
