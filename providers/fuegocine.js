 ...
 * Generated: 2026-04-13T02:24:32.298Z
 */
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const { data: searchJson } = yield axios2.get(SEARCH_BASE + encodeURIComponent(searchTitle), { timeout: 8e3 });
      ...
      for (const entry of entries) {
        ...
        if (!normEntry.includes(normTitle))
          continue;
        const { data: html } = yield axios2.get(entryUrl, { timeout: 8e3 });
