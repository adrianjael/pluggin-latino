 ...
 * Generated: 2026-04-12T20:34:22.063Z
 */
...
var HEADERS = { "User-Agent": UA9, "Accept": "application/json" };
...
function getIdBySlug(category, slug) {
  return __async(this, null, function* () {
    ...
    try {
      const { data: html } = yield axios9.get(url, {
        timeout: 8e3,
...
function getEpisodeId(seriesId, seasonNum, episodeNum) {
  return __async(this, null, function* () {
    ...
    try {
      const { data } = yield axios9.get(url, { timeout: 12e3, headers: HEADERS });
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const { data } = yield axios9.get(`${BASE_URL}/wp-api/v1/player?postId=${targetId}&demo=0`, { timeout: 6e3, headers: HEADERS });
