 ...
 * Generated: 2026-04-08T21:34:13.167Z
 */
  ...
  return __async(this, null, function* () {
    ...
    for (const { lang } of attempts) {
      try {
        ...
        const { data } = yield import_axios4.default.get(url, { timeout: 5e3, headers: HEADERS });
...
function getEpisodeId(seriesId, seasonNum, episodeNum) {
  return __async(this, null, function* () {
    ...
    try {
      const { data } = yield import_axios4.default.get(url, { timeout: 12e3, headers: HEADERS });
...
function getStreams(tmdbId, mediaType, season, episode) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      const { data } = yield import_axios4.default.get(`${BASE_URL}/wp-api/v1/player?postId=${targetId}&demo=0`, { timeout: 6e3, headers: HEADERS });
