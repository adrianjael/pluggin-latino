 ...
 * Generated: 2026-04-14T20:48:41.535Z
 */
...
function getImdbId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const { data } = yield axios5.get(url, { timeout: 5e3, headers: { "User-Agent": UA4 } });
...
function getEmbeds(slug, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      const { data: html } = yield axios5.get(`${BASE_URL}${path}`, { timeout: 8e3, headers: HTML_HEADERS });
