 ...
 * Generated: 2026-04-13T05:03:42.908Z
 */
...
function getImdbId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const { data } = yield axios6.get(url, { timeout: 5e3, headers: { "User-Agent": UA4 } });
...
function getEmbeds(slug, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      const { data: html } = yield axios6.get(`${BASE_URL}${path}`, { timeout: 8e3, headers: HTML_HEADERS });
