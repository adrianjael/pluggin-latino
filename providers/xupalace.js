 ...
 * Generated: 2026-04-13T02:24:32.374Z
 */
...
function getImdbId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const { data } = yield axios2.get(url, { timeout: 5e3, headers: { "User-Agent": UA2 } });
...
function getEmbeds(slug, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      const { data: html } = yield axios2.get(`${BASE_URL}${path}`, { timeout: 8e3, headers: HTML_HEADERS });
