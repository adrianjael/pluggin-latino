 ...
 * Generated: 2026-04-15T21:15:17.622Z
 */
    ...
    function resolve6(embedUrl) {
      return __async(this, null, function* () {
        ...
        try {
          ...
          try {
            const headRes = yield axios5.head(targetUrl, { headers, timeout: 5e3 });
          ...
          const { data: html } = yield axios5.get(targetUrl, { headers, timeout: 8e3 });
          ...
          try {
            const videoCheck = yield axios5.head(directUrl, { headers, timeout: 4e3 });
...
function getImdbId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const { data } = yield axios4.get(url, { timeout: 5e3, headers: { "User-Agent": UA4 } });
...
function getEmbeds(slug, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      const { data: html } = yield axios4.get(`${BASE_URL}${path}`, { timeout: 8e3, headers: HTML_HEADERS });
