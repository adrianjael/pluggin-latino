 ...
 * Generated: 2026-04-12T23:27:34.328Z
 */
...
function getImdbId(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const { data } = yield axios9.get(url, { timeout: 5e3, headers: { "User-Agent": UA9 } });
...
function getEmbeds(slug, mediaType, season, episode) {
  return __async(this, null, function* () {
    try {
      ...
      const { data: html } = yield axios9.get(`${BASE_URL}${path}`, { timeout: 8e3, headers: HTML_HEADERS });
