 ...
 * Generated: 2026-04-12T23:52:51.559Z
 */
...
function resolveByseInternal(url) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      for (const langObj of data) {
        ...
        for (const player of serverList) {
          ...
          const resolved = yield resolveEmbed2(streamUrl);
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    if (candidates.length === 0 && mediaTitle.includes(" ")) {
      ...
      console.log(`[GnulaHD] Sin resultados, intentando b\xFAsqueda relajada: ${firstWord}`);
