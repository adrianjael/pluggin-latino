 ...
 * Generated: 2026-04-15T23:41:47.976Z
 */
            ...
            mirrors.forEach((mirror) => __async(this, null, function* () {
              try {
                ...
                const resp = yield fetch(mirror, {
                  headers: { "Referer": mirror, "User-Agent": UA5 },
                  signal
                });
                if (!resp.ok)
                  throw new Error();
    ...
    const tryDownload = (isRetry = false) => __async(this, null, function* () {
      try {
        ...
        if (spawnSync && typeof process !== "undefined") {
          ...
          html = yield fetchHtml2(playerUrl, {
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    try {
      const performSearch = (titleQuery) => __async(this, null, function* () {
        ...
        try {
          if (spawnSync && typeof process !== "undefined") {
            ...
            html = yield fetchHtml2(url, { headers: { "User-Agent": UA4 } });
          }
        } catch (e) {
      ...
      const mediaHtml = yield fetchHtml2(finalMediaUrl, {
