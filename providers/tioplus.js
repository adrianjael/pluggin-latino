 ...
 * Generated: 2026-04-13T21:55:02.290Z
 */
...
function getStreams(tmdbId, mediaType, season, episode, title) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (mediaType !== "movie") {
        const s2 = parseInt(season) || 1;
        const e = parseInt(episode) || 1;
        finalMediaUrl = `${targetUrl}/season/${s2}/episode/${e}`;
      }
        ...
        try {
          ...
          if (realEmbedUrl && realEmbedUrl.startsWith("http")) {
            ...
            if (resolved && (resolved.url || Array.isArray(resolved) && resolved.length > 0)) {
              ...
              streamsArray.forEach((s2) => {
                resolvedStreams.push(__spreadProps(__spreadValues({}, s2), {
