 ...
 * Generated: 2026-04-12T20:42:08.758Z
 */
...
function getTmdbInfo(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const html = yield (0, import_http5.fetchHtml)(url, url);
...
var import_cheerio_without_node_native, import_http5;
var init_extractor = __esm({
  "src/pelispanda/extractor.js"() {
    import_cheerio_without_node_native = __toESM(require("cheerio-without-node-native"));
    import_http5 = __toESM(require_http());
    init_string();
    init_crypto();
    init_resolvers();
    init_m3u8();
