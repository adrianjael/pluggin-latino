 ...
 * Generated: 2026-04-13T04:37:03.247Z
 */
...
function getTmdbInfo(tmdbId, mediaType) {
  return __async(this, null, function* () {
    try {
      ...
      const html = yield (0, import_http4.fetchHtml)(url, url);
...
var import_cheerio_without_node_native, import_http4, import_resolvers, import_m3u8;
var init_extractor = __esm({
  "src/pelispanda/extractor.js"() {
    import_cheerio_without_node_native = __toESM(require("cheerio-without-node-native"));
    import_http4 = __toESM(require_http());
    init_string();
    init_crypto();
