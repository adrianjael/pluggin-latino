 ...
 * Generated: 2026-04-12T22:27:29.158Z
 */
  ...
  return __async(this, null, function* () {
    try {
      ...
      return {
        ...
        headers: { "User-Agent": UA6, "Referer": "https://ok.ru/" }
      };
    } catch (e) {
...
var init_m3u8 = __esm({
  "src/utils/m3u8.js"() {
    UA8 = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36";
  }
});
    ...
    try {
      ...
      const streamPromises = playerData.data.map((player) => __async(this, null, function* () {
        ...
        if (rawUrl.includes("hlswish") || rawUrl.includes("streamwish") || rawUrl.includes("hglamioz") || rawUrl.includes("embedwish"))
          ...
          serverName = "vimeos";
        resolvedData = yield resolveEmbed(finalUrl);
