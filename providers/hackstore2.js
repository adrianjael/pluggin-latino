 ...
 * Generated: 2026-04-13T04:06:30.645Z
 */
      ...
      return __async(this, null, function* () {
        try {
          ...
          return {
            ...
            quality,
            serverName: "VidHide",
            headers: { "User-Agent": UA2, "Referer": domain + "/", "Origin": domain }
          };
        } catch (e) {
  ...
  "src/utils/resolvers.js"(exports2, module2) {
    ...
    function getDirectCdnHeaders(url) {
      ...
      try {
        ...
        const headers = { "User-Agent": UA2, "Referer": `https://${domain}/`, "Origin": `https://${domain}` };
        ...
        return { "User-Agent": UA2, "Referer": url };
      }
    }
