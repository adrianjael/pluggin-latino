 ...
 * Generated: 2026-04-10T15:02:48.995Z
 */
    ...
    try {
      ...
      if (!unpacked) {
        ...
        if (m3u8Match && m3u8Match[1]) {
          ...
          return { url: url1, quality: q1, headers: { "User-Agent": DEFAULT_UA2, "Referer": "https://fastream.to/" } };
        }
        return null;
      }
...
function getStreams(tmdbId, mediaType, season, episode, title, year) {
  return __async(this, null, function* () {
    try {
      ...
      return yield finalizeStreams(streams, "HackStore2");
    } catch (error) {
