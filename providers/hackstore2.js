 ...
 * Generated: 2026-04-13T04:37:03.228Z
 */
    ...
    function resolve9(url) {
      return __async(this, null, function* () {
        try {
          ...
          const response = yield axios6.get(url, { headers: { "User-Agent": UA4 }, timeout: 8e3 });
          let html = response.data;
          if (html.indexOf("Redirecting") !== -1 || html.length < 1500) {
            const rm = html.match(/window\.location\.href\s*=\s*['"]([^'"]+)['"]/i);
            if (rm) {
              const res2 = yield axios6.get(rm[1], { headers: { "User-Agent": UA4 }, timeout: 8e3 });
              html = res2.data;
            }
          }
      ...
      return __async(this, null, function* () {
        try {
          ...
          try {
            ...
            const { data: pbData } = yield axios6.get(`https://${targetHost}/api/videos/${targetCode}/embed/playback`, { headers: pbHeaders, timeout: 8e3 });
            if (pbData.playback) {
...
var import_axios2, DEFAULT_UA2, MOBILE_UA;
var init_http2 = __esm({
  "src/utils/http.js"() {
    import_axios2 = __toESM(require("axios"));
    DEFAULT_UA2 = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";
  ...
  return __async(this, null, function* () {
    try {
      ...
      var data = yield fetchHtml2(url, {
        headers: { "User-Agent": DEFAULT_UA2, "Referer": "https://www3.seriesmetro.net/" }
      });
      ...
      if (!unpacked) {
        ...
        if (m3u8Match && m3u8Match[1]) {
          ...
          return {
            ...
            quality: q1 || "1080p",
            serverName: "Fastream",
            headers: { "User-Agent": DEFAULT_UA2, "Referer": "https://fastream.to/" }
          };
        }
        return null;
      }
...
var require_playmogo = __commonJS({
  "src/resolvers/playmogo.js"(exports2, module2) {
    var { fetchHtml: fetchHtml3, DEFAULT_UA: DEFAULT_UA3 } = (init_http2(), __toCommonJS(http_exports));
    function resolve9(url) {
      return __async(this, null, function* () {
        try {
...
var require_resolvers = __commonJS({
  "src/utils/resolvers.js"(exports2, module2) {
    ...
    var { resolve: resolveVimeos2 } = (init_vimeos(), __toCommonJS(vimeos_exports));
    ...
    function getDirectCdnHeaders(url) {
      ...
      try {
        ...
        return { "User-Agent": UA4, "Referer": url };
      }
    }
  ...
  return __async(this, null, function* () {
    ...
    try {
      ...
      const streamPromises = playerData.data.map((player) => __async(this, null, function* () {
        ...
        let finalUrl = rawUrl;
        if (rawUrl.includes("hlswish") || rawUrl.includes("streamwish") || rawUrl.includes("hglamioz") || rawUrl.includes("embedwish"))
          serverName = "streamwish";
        else if (rawUrl.includes("vidhide") || rawUrl.includes("dintezuvio"))
          serverName = "vidhide";
...
function getStreams(tmdbId, mediaType, season, episode, title, year) {
  return __async(this, null, function* () {
    try {
      ...
      const streams = yield extractStreams2(tmdbId, mediaType, season, episode, mediaTitle, year);
      return yield finalizeStreams(streams, "HackStore2", mediaTitle);
    } catch (error) {
